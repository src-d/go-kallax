...
type QueryFixture struct {
	...
	//TODO: AliasArrAliasSliceParam  fixtures.AliasArrAliasSlice //ERR: sql: Scan error on column index 25: kallax: cannot scan type %!s(<nil>) into JSON type
	//TODO: ArrayArrayParam          [][]string //ERR: sql: Scan error on column index 25: kallax: cannot scan type %!s(<nil>) into JSON type
