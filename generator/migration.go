...
var typeMappings = map[string]ColumnType{
	"github.com/networkteam/go-kallax.ULID":      UUIDColumn,
	"github.com/networkteam/go-kallax.UUID":      UUIDColumn,
	"github.com/networkteam/go-kallax.NumericID": BigIntColumn,
